...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 text-gray-900 dark:text-[#FFF] bg-white dark:bg-gray-800 antialiased tracking-tight">
      <Head>
